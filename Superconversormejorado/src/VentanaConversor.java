...
public class VentanaConversor extends JFrame {
	...
	String nombre_moneda[]= new String[4];

	//Creo primer array
	float monedas[]= new float[3] ;
		...
		comboBox.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				switch ((String)comboBox.getSelectedItem()) //dentro del combo cn el listener y el switch asigno el valor de conversión
					{
					case "Dolares" :
						factor_conversion = monedas[0] ;
						moneda_seleccionada = nombre_moneda[0];
					...
					case "Corona Checa" :
						factor_conversion = monedas[1] ;
						moneda_seleccionada = nombre_moneda[1];
						textField_mensaje.setText("Ha seleccionado: " + moneda_seleccionada );
						break;
						
					case "Yen" :
						factor_conversion = monedas[2] ;
						moneda_seleccionada = nombre_moneda[2];
						textField_mensaje.setText("Ha seleccionado: " + moneda_seleccionada );

						break;
						
					default:
						moneda_seleccionada = nombre_moneda[3];
